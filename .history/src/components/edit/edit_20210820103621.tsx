                ...
                <div style={{ background: '#fff' }} >
                    ...
                    <div className="padlr10">
                        <div className="flex-sb">
                            ...
                            <div className={`${styles.timeicon} flex-ja`} onClick={() => { setShow(true) }}>{data ? dayjs(data.date).format(`MM-DD`) : dayjs(value1).format(`MM-DD`)}<i className={`iconfont icon-jiantou9 ${styles.icon}`}></i></div>
                        </div>
