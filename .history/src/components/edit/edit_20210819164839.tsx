                        ...
                        <div className="flex-sb">
                            <div className='flex'>
                                {arr.map((item: any, index: number) => {
                                    return <div key={index} className={`${styles.zhichu} ${(active ? active - 1 : 0) === index && index == 0 ? styles.zhichu1 : ''} ${(active ? active - 1 : 0) === index && index == 1 ? styles.shouru1 : ''}`} onClick={() => { setActive(index) }}>{item}{active}</div>
                                })}
                            </div>
