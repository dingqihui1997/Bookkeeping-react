                        ...
                        <div className="flex-sb">
                            <div className='flex'>
                                {arr.map((item: any, index: number) => {
                                    return <div key={index} className={`${styles.zhichu} ${(props.data && props.data.pay_type) === index + 1 && index == 0 ? styles.zhichu1 : ''} ${(props.data && props.data.pay_type) === index + 1 && index == 1 ? styles.shouru1 : ''}`} onClick={() => { setActive(index) }}>{item}{active}</div>
                                })}
                            </div>
