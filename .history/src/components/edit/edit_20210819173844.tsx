...
const edit = (props: props) => {
    ...
    let [active, setActive] = useState((props.data && props.data ? props.data.pay_type : 1))//支出收入控制下标
    let [show, setShow] = useState(false)//时间弹框
    let [arr, setArr] = useState(['支出', '收入'])
    let [price, setPrice] = useState(props.data && props.data.amount ? props.data && props.data.amount && props.data.amount : '')//金额
    // console.log(price)
