...
const edit = (props: props) => {
    ...
    // let [active, setActive] = useState(props.data?props.data.pay_type:)//支出收入控制下标
            ...
            >
                <div style={{ background: '#fff' }} >
                    ...
                    <div className="padlr10">
                        <div className="flex-sb">
                            <div className='flex'>
                                {arr.map((item: any, index: number) => {
                                    return <div key={index} className={`${styles.zhichu} ${(props.data ? props.data.pay_type : 1) === index + 1 && index == 0 ? styles.zhichu1 : ''} ${(props.data ? props.data.pay_type : 1) === index + 1 && index == 1 ? styles.shouru1 : ''}`} onClick={() => { setActive(index) }}>{item}{active}</div>
                                })}
                            </div>
                        ...
                        {(props.data ? props.data.pay_type : 1) === 1 ? <div className={`flex ${styles.boxicon}`}>
