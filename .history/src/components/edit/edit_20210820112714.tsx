                ...
                <div style={{ background: '#fff' }} >
                    ...
                    <div className="padlr10">
                        <div className="flex-sb">
                            ...
                            <div className={`${styles.timeicon} flex-ja`} onClick={() => { setShow(true) }}>{data ? dayjs(Number(data.date)).format(`MM-DD`) : dayjs(value1).format(`MM-DD`)}<i className={`iconfont icon-jiantou9 ${styles.icon}`}></i></div>
                        </div>
                        ...
                        {flag ? <div className={`${styles.addremarks}`} onClick={() => { setFlag(false) }}>{data && data.remark ? data.remark : '添加备注'}</div> : <div className={`${styles.autoinput}`}>
                            <Input
                                ...
                                type="text"
                                placeholder="请输入备注信息"
                                value={data ? data.remark : content}
