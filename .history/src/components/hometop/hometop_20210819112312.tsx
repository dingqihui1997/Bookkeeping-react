            ...
            >
                <div style={{ height: 500, background: "#eee" }}>
                    ...
                    <div style={{ paddingLeft: 20, paddingRight: 20, paddingTop: 10 }}>
                        <div className={`${styles.all11} ${id == 'all' ? styles.expend : ''}`} onClick={() => { expend('all', '全部类型'), setId('all'), props.choice(value, 'all') }}>全部类型</div>
            ...
            > <div style={{ height: 255, background: "#fff" }}>
                    <DatePicker
                        ...
                        onOk={(e: any) => {
                            ...
                            setShow(false)
                            console.log(id)
                            props.choice(dayjs(e).format(`YYYY-MM`), id)
                        }}
                        onCancel={() => {
                            setShow(false)
                        }}
