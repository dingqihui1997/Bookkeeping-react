                ...
                <div>
                    ...
                    {list.sort((a: any, b: any) => {
                        ...
                        return <div key={index1} className="mat10 flex-a" style={{ height: 50 }}>
                            <div>  <i className={`iconfont ${iconone && iconone.info} ${item1.pay_type === 1 ? styles.dataicon : styles.dataicon1}`}></i></div>
                            <div className="mal10 font12"> {item1.type_name}</div>
                            <div className="font12 marr10">￥{item1.number}</div>
                            <div className="progress" style={{ width: 200 }}> <Progress
                                shape="line"
                                percent={item1.pay_type === 1 ? Number((item1.number / totalExpense).toFixed(2)) * 100 : Number((item1.number / totalIncome).toFixed(2)) * 100}
