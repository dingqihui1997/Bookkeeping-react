        ...
        <div style={{ height: "100vh", background: "#F5F5F5" }}>
            ...
            <div className="back3f">
                ...
                <div className="flex-sb  mat10 padlr10 pad-t20">
                    ...
                    <div className="flex font14">
                        {arr.map((item: any, index: number) => {
                            return <div key={index} className={`${styles.dataExpense} ${active === index && index == 0 ? styles.dataExpense1 : ''} ${active === index && index == 1 ? styles.dataIncome : ''}`} onClick={() => { setnum(index) }}>{item}</div>
                        })}
                    </div>
                </div>
            </div>
