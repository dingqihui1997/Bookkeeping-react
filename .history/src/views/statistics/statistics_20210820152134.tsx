...
const Statistics = () => {
    ...
    return (
        <div style={{ height: "100%", background: "#F5F5F5" }}>
                ...
                <div>
                    {list.sort((a: any, b: any) => {
                        ...
                        return <div key={index1} className="mat10 flex-a" style={{ height: 50 }}>
                            ...
                            <div><div className="mal10 font12"> {item1.type_name}</div>
                                <div className="font12 marr10">￥{item1.number}</div></div>
            ...
            <div id="main" style={{ width: "100%", height: 300, background: "#FFF" }}></div>
            <DatePicker
                visible={show}
                title="选择日期"
                okText="确定"
