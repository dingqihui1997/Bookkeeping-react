...
const Home = () => {
    ...
    let time = dayjs(new Date()).format(`MM-DD`)//当前时间,默认时间
                ...
                <div style={{ height: 470, background: '#fff' }}>
                    ...
                    <div className="padlr10">
                        <div className="flex-sb">
                            ...
                            <div className={`${styles.timeicon} flex-ja`} onClick={() => { setShow(true) }}>8-17<i className={`iconfont icon-jiantou9 ${styles.icon}`}></i></div>
                        </div>
                    </div>
                </div>
                <Popup
