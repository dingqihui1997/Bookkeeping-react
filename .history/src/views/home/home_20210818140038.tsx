...
const Home = () => {
    ...
    let [billlist, setBill] = useState([])//账单列表
    ...
    let addbill = () => {
        ...
        // let oldTime = String((dayjs(value)).valueOf());
        api.addbill({ amount: Number(price), type_id: id, type_name: name, date: value1, pay_type: pay, remark: content }).then((res: any) => {
            console.log(res)
            if (res.code === 200) {
                setVisible(false)
            }
