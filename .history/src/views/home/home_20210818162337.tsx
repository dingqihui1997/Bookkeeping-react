                    ...
                    return <div key={index} className={`${styles.boxbill} mat10`}>
                        <div className={`${styles.billtop} flex-sba mal10`}>
                            ...
                            <div className="flex-ja">
                                <div><img src="http://s.yezgea02.com/1615953405599/zhi%402x.png" className="shouzhi"></img><span className="font12 flex-a">{num}</span></div>
                                <div><img src='http://s.yezgea02.com/1615953405599/shou%402x.png' className="shouzhi" /><span className="font12"> {num1}</span></div>
                            </div>
                        </div>
                        {item.bills.map((item1: any, index: number) => {
                            return <div className={`${styles.boxcontent} flex-dj`} key={index}>
