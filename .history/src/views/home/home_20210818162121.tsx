                ...
                {billlist.map((item: any, index: number) => {
                    ...
                    return <div key={index} className={`${styles.boxbill} mat10`}>
                        <div className={`${styles.billtop} flex-sba mal10`}>
                            ...
                            <div className="flex">
                                <div><img src="http://s.yezgea02.com/1615953405599/zhi%402x.png" className="shouzhi"></img>{num}</div>
                                <div><img src='http://s.yezgea02.com/1615953405599/shou%402x.png' className="shouzhi" />{num1}</div>
                            </div>
                        </div>
