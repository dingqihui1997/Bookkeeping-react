...
import { Icon, TabBar, Cell, Button, Popup, DatePicker, Input } from 'zarm';
                    ...
                    <div className="padlr10">
                        ...
                        {active === 0 ? <div className={`flex ${styles.boxicon}`}>
                            ...
                            {list2.map((item: any, index: number) => {
                                return <div key={index} className={`${styles.iconexpend}`} onClick={() => { setIncome(index) }}>
                        ...
                        {flag ? <div className={`${styles.addremarks}`} onClick={() => { setFlag(false) }}>添加备注</div> : <div>
                            <Cell title="多行文本">
                                <Input
                                    rows={3}
                                    type="text"
