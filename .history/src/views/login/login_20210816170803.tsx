...
const Login = () => {
    ...
    let [num, setNum] = useState<any[]>(["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z", 1, 2, 3, 4, 5, 6, 7, 8, 9, 0])
    ...
    let code = () => {
        let arr1 = []
        if (num.length === 0) {
            setNum(["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z", 1, 2, 3, 4, 5, 6, 7, 8, 9, 0])
        } else {
            for (var i = 0; i < 4; i++) {
