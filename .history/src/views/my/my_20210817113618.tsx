    ...
    return (
        <div>
            ...
            <Cell
                hasArrow
                title="重置密码"
                icon={<img alt="" src='http://s.yezgea02.com/1615974766264/zhaq.png' style={{ width: 24, height: 24 }} />}

            />
            <Cell
                hasArrow
                title="关于我们"
                icon={<img alt="" src='http://s.yezgea02.com/1615975178434/lianxi.png' style={{ width: 24, height: 24 }} />}
