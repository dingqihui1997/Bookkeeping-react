        ...
        <div style={{ height: "100vh", background: "#F5F5F5" }}>
            ...
            <div className={`${styles.deta} flex-d`}>
                <div className="flex1 flex-ja">
                    <div><i className={`iconfont ${oneicon && oneicon.info} font30 ${styles.infonicon} ${data?.pay_type == 1 ? styles.infonicon : styles.infonicon1}`}></i></div>
                ...
                <div className="flex1 flex-ja">
                    ...
                    <div className="flex1 flex-ja" onClick={() => { setflag(!flag), setVisible(true) }}><MyIcon type="icon-bianji" theme="primary" />编辑</div>
                </div>
            </div>
            <div >
                <Edit inedit={true} visible={visible} setvisible={setvisible1} data={data} success={success}></Edit>
            </div>
        </div >
    )
}
