    ...
    return (
        ...
        <div style={{ height: "100vh", background: "#F5F5F5" }}>
            ...
            <div className={`${styles.deta} flex-d`}>
                ...
                <div className="flex1 flex-ja">{data && data!.pay_type == 1 ? '-' + data && data!.amount : '+' + data && data!.amount}</div>
                <div className="flex1 ">记录时间：{(dayjs(Number(data!.date)).format(`YYYY-MM-DD HH:mm`))}</div>
