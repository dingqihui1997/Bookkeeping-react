...
export default {
    ...
    update({ id, amount, type_name, date, pay_type, remark }: { amount: number, id: number, type_name: string, date: string, pay_type: number, remark: string }) {
        return http.post('/api/bill/add', { amount, id, type_name, date, pay_type, remark })
    },
}
